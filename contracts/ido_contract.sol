...
contract IDOSale is AccessControl, Pausable, ReentrancyGuard {
    ...
    function initialize(IERC20 _ido,IERC20 _purchaseToken,uint256 _idoPrice,uint256 _purchaseCap,uint256 _startTime,uint256 _endTime) public onlyOwner{
    ...
    function depositTokens(uint256 amount) external onlyOperator whenNotPaused {
        ...
        ido.transferFrom(_msgSender(), address(this), amount);
    ...
    function purchase(uint256 amount) external nonReentrant whenNotPaused {
        ...
        purchaseToken.transferFrom(_msgSender(), address(this), purchaseTokenAmount);
    ...
    function claim(uint256 amount) external nonReentrant whenNotPaused {
        ...
        ido.transfer(_msgSender(), amount);
